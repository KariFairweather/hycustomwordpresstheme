...
function hackeryou_styles(){
	...
	wp_enqueue_style('wpb-google-fonts', 'https://fonts.googleapis.com/css?family=Roboto|Lora', false);
}
...
function hackeryou_continue_reading_link() {
	return ' <a class="continue-reading" href="'. get_permalink() . '">Continue reading</a>';
}
